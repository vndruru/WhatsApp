...
global.ftoko = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? {remoteJid: "status@broadcast" } : {})}, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./stik/quoted.jpg')},"title": `Created By Ehanz`, "description": `${fake1}`, "currencyCode": "IDR", "priceAmount1000": "15000", "retailerId": `${fake1}`, "productImageCount": 1}, "businessOwnerJid": `0@s.whatsapp.net`}}} 
    
global.repPy = { key: { remoteJid: '0@s.whatsapp.net',fromMe: false,id: 'ʀαηgєʟ вσт ᵕ̈ᝰ',participant: '0@s.whatsapp.net'},message: {requestPaymentMessage: {currencyCodeIso4217: "USD",amount1000: 999999999,requestFrom: '0@s.whatsapp.net',noteMessage: {extendedTextMessage: {text: 'ʀαηgєʟ вσт ᵕ̈ᝰ By єнanz'}},expiryTimestamp: 999999999,amount: {value: 91929291929,offset: 1000,currencyCode: "USD"}}}}
    
global.fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `0@s.whatsapp.net` } : {}) }, message: { 'contactMessage': { 'displayName': `Created By Ehanz`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${m.pushname},;;;\nFN:${m.pushname},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
...
global.fdoc = { key : { participant : '0@s.whatsapp.net'}, message: { documentMessage: { title: 'Created By ehanz', jpegThumbnail: fs.readFileSync('./stik/quoted.jpg')}}}

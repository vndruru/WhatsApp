...
//await sleep(400)  
console.log(`${chalk.white(`[`)+chalk.red(`3`)+chalk.white(`]`)}`,`data 5`)
//await sleep(400) 

console.log(chalk.magenta(`]─`),`「`,  chalk.red(`GamonBOT`), `」`,  chalk.magenta(`─[`))  
start(`1`,`Connecting...`)
} else if (connection === 'open') { conn.sendMessage(`6281316643491@s.whatsapp.net`, {text: `Alo Ayang Aku On Kembali><`})
success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
}
